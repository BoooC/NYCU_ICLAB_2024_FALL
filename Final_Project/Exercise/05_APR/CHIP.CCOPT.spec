...
#  Generated on:      Tue Dec 24 03:31:41 2024
#  Design:            CHIP
...
#   clk (period 2.200ns) in timing_config func_mode([CHIP_cts.sdc])
create_ccopt_clock_tree -name clk -source clk -no_skew_group

set_ccopt_property source_output_max_trans -delay_corner Delay_Corner_max -early -clock_tree clk 0.000
set_ccopt_property source_output_max_trans -delay_corner Delay_Corner_min -early -clock_tree clk 0.000
set_ccopt_property source_output_max_trans -delay_corner Delay_Corner_max -late -clock_tree clk 0.000
set_ccopt_property source_output_max_trans -delay_corner Delay_Corner_min -late -clock_tree clk 0.000
set_ccopt_property source_max_capacitance -clock_tree clk 0.500
